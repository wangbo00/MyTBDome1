package wangbo.bawei.com.mytbdome.shoping.view.adapter;
...
public class MyAdapter extends BaseExpandableListAdapter{
    ...
    public MyAdapter(ShopPing activity, List<CartBean.DataBean> listGroup, List<List<CartBean.DataBean.ListBean>> listChilds, Handler handler) {
    }
